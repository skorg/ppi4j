...
final class DataScanner extends TokenScanner
{
    ...
    {
        /*
         * PPI::Tokenizer::_process_next_char would create this token in the 'if ( $result eq '1' )' section after returning from
         * __TOKENIZER__on_char, but that only works b/c perl allows for multiple return types.
         *
